...
typedef union _AHCI_HBA_CAPABILITIES  {
    ...
    struct {
        ...
        ULONG SSS :1; //Supports Staggered Spin-up: When set to ? , indicates that the HBA supports staggered spin-up on its ports, for use in balancing power spikes. This value is loaded by the BIOS prior to OS initiallization.
